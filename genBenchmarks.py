...
ga_params = [
    ...
    (100,  5, 60, 1, 5), # Best
    (200,  5, 60, 1, 5), # More pop
    (50,  5, 60, 1, 5), # Less pop
    (100,  10, 60, 1, 5), # More tourn
    (100,  2, 60, 1, 5), # Less tourn
    (100,  5, 80, 1, 5), # More mut
    (100,  5, 30, 1, 5), # Less mut
    (100,  5, 60, 5, 5), # More %mut
    (100,  5, 60, 0.5, 5), # Less %mut
    (100,  5, 60, 1, 8), # More %elite
    (100,  5, 60, 1, 2), # Less %elite
]
